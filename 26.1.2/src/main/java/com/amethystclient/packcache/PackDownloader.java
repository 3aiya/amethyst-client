...
public final class PackDownloader {
	...
	public static Map<String, String> vanillaHeaders(Minecraft client) {
		Map<String, String> headers = new LinkedHashMap<>();
		String version = SharedConstants.getCurrentVersion().name();
		headers.put("User-Agent", "Minecraft Java/" + version);
		headers.put("X-Minecraft-Username", client.getUser().getName());
		...
		headers.put("X-Minecraft-Version-ID", SharedConstants.getCurrentVersion().id());
		return headers;
	}
}
